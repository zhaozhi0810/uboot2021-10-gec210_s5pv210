...
static void dm9000_pre_init(void)
{
	...
	gpio_cfg_pin(S5PC110_GPIO_MP010 + DM9000_ENV_SROM_BANK, S5P_GPIO_FUNC(2));
 
	/* Ethernet needs bus width of 16 bits */
	smc_bw_conf = SMC_DATA16_WIDTH(DM9000_ENV_SROM_BANK)    |   
                    SMC_BYTE_ADDR_MODE(DM9000_ENV_SROM_BANK)|
                    SMC_WAIT_ENABLE(DM9000_ENV_SROM_BANK)   |   
                    SMC_BYTE_ENABLE(DM9000_ENV_SROM_BANK);
    ...
    s5p_config_sromc(DM9000_ENV_SROM_BANK, smc_bw_conf, smc_bc_conf);
}
